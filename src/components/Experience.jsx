                ...
                {EXPERIENCES.map((experience, index) => (
                    <div className="mb-8 flex flex-wrap lg:justify-center" key={index}>
                        <motion.div
                            ...
                            <p className='mb-2 text-[15px] text-neutral-400'>{experience.year}</p>
                        </motion.div>
                        <motion.div
                            whileInView={{ opacity: 1, x: 0 }}
                            initial={{ opacity: 0, x: 100 }}
                            ...
                            <h6 className='mb-2 font-semibold'>
                                {experience.role} - <span className='font-semibold text-[15px] text-purple-100'>{experience.company}</span>
                            </h6>
